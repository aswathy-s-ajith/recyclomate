            ...
            <div style={styles.card}>
              ...
              <div>
                <div style={styles.pickupItem}>
                  ...
                  <div>
                    <p style={styles.pickupLabel}>Ectom fron</p>
                ...
                <div style={styles.pickupItem}>
                  ...
                  <div>
                    <p style={styles.pickupLabel}>Rego!</p>
                    <p style={styles.pickupValue}>{nextPickup.date}, {nextPickup.time}</p>
                  </div>
                </div>
              </div>
              <button 
            ...
            <div style={styles.nextPickupCard}>
              <div style={{ marginBottom: '1rem' }}>
                <div style={styles.statCardContent}>
                  ...
                  <div>
                    <p style={styles.statLabel}>Upcoming Pickup</p>
                  </div>
                </div>
              </div>
