...
const SignupDriver = () => {
  ...
  return (
    <div style={styles.signupContainer}>
      ...
      <h2 style={styles.signupTitle}>Sign Up as Driver</h2>
      ...
      <form onSubmit={handleSubmit} style={styles.signupForm}>
        ...
        <div style={styles.inputGroup}>
          <input type="text" name="vehicleNumber" placeholder="Vehicle Number" value={formData.vehicleNumber} onChange={handleChange} style={styles.signupInput} required />
        </div>

        <div style={styles.inputGroup}>
          <input type="text" name="licenseNumber" placeholder="License Number" value={formData.licenseNumber} onChange={handleChange} style={styles.signupInput} required />
        </div>

        <div style={styles.inputGroup}>
          <input type="text" name="vehicleType" placeholder="Vehicle Type (e.g., Truck, Van, Bike)" value={formData.vehicleType} onChange={handleChange} style={styles.signupInput} required />
        </div>

        <div style={styles.inputGroup}>
          <label style={{ marginBottom: '5px', color: '#555', fontWeight: '500' }}>Role</label>
          <input type="text" name="role" value="Driver" readOnly style={{ ...styles.signupInput, backgroundColor: '#e9ecef', cursor: 'not-allowed' }} />
        </div>
